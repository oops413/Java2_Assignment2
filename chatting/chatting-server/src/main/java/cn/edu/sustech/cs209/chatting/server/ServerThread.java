            ...
            while (true) {
                ...
                switch (instruction) {
                    ...
                    case SendMessage: {
                        ...
                        System.out.println("私聊为什么寄 "+onMessage.getSentBy());

                        if(Server.allThread.containsKey(two)) {
                            Message finalOnMessage = onMessage;

                            System.out.println("again "+finalOnMessage.getSentBy());
                            ...
                            if(o.getRoomName().equals(room)){
                                o.getRoomMember().forEach(t->{
                                    if(Server.allThread.containsKey(t)&&!t.equals(finalOnMessage1.getSentBy())){
                                        ...
                                        try{
                                            System.out.println("进到发群聊里了嘛 ");
                                            System.out.println("sentby shi "+ finalOnMessage1.getSentBy());
                                            System.out.println("roomnameshi "+finalOnMessage1.getRoomName());
                                            tempOs.reset();
